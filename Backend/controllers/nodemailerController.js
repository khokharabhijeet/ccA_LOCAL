  ...
  try {
    ...
    for (const plantId in plants) {
      ...
      const csvWriter = createObjectCsvWriter({
        ...
        { id: 'humidity.internal.Sensor1', title: 'Internal Humidity Sensor 1' },
        { id: 'humidity.internal.Sensor2', title: 'Internal Humidity Sensor 2' },
        { id: 'humidity.internal.Sensor3', title: 'Internal Humidity Sensor 3' },
        { id: 'humidity.internal.Sensor4', title: 'Internal Humidity Sensor 4' },
        { id: 'humidity.external.Sensor1', title: 'External Humidity Sensor 1' },
        { id: 'humidity.external.Sensor2', title: 'External Humidity Sensor 2' },
        { id: 'humidity.external.Sensor3', title: 'External Humidity Sensor 3' },
        { id: 'soilTemperature.internal.Sensor1', title: 'Internal Soil Temperature Sensor 1' },
        { id: 'soilTemperature.internal.Sensor2', title: 'Internal Soil Temperature Sensor 2' },
        { id: 'soilTemperature.internal.Sensor3', title: 'Internal Soil Temperature Sensor 3' },
        { id: 'soilTemperature.internal.Sensor4', title: 'Internal Soil Temperature Sensor 4' },
      ...
      'soilTemperature.internal.Sensor1': item.data.soilTemperature.internal.Sensor1,
      'soilTemperature.internal.Sensor2': item.data.soilTemperature.internal.Sensor2,
      'soilTemperature.internal.Sensor3': item.data.soilTemperature.internal.Sensor3,
      'soilTemperature.internal.Sensor4': item.data.soilTemperature.internal.Sensor4,
      'soilTemperature.internal.Sensor5': item.data.soilTemperature.internal.Sensor5,
      'soilTemperature.internal.Sensor6': item.data.soilTemperature.internal.Sensor6,
      'soilTemperature.internal.Sensor7': item.data.soilTemperature.internal.Sensor7,
      'soilTemperature.internal.Sensor8': item.data.soilTemperature.internal.Sensor8,
